        ...
        <div className="py-4 px-8 bg-white shadow-lg rounded-lg my-20 bg-slate-100">
            <div className="flex justify-center md:justify-end -mt-16">
                <img
                    ...
                    height={80}
                    width={80}
                    src={props.imgSrc ? '' : 'https://randomuser.me/api/portraits/men/46.jpg'}
                />
            </div>
            <div>
            ...
            {new Date(props.datePost).getDate().toString()}-{new Date(props.datePost).getMonth().toString()}-{new Date(props.datePost).getFullYear().toString()}
            </div>
        </div>
    )
}